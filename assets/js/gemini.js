...
document.addEventListener("DOMContentLoaded", function () {
  setTimeout(initializeAIFunctions, 200);
});
...
async function callGemini(userPrompt, resultElementId, loaderId) {
  ...
  try {
    ...
    resultDiv.innerHTML = `<span class="text-red-300">Maaf, terjadi kesalahan: ${error.message}. Pastikan koneksi internet stabil dan coba lagi.</span>`;
    resultDiv.classList.remove("hidden");
  } finally {
